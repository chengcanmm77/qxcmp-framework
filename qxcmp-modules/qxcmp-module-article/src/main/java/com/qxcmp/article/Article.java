 ...
 * @author aaric
 */
@EntityTable(value = "我的文章", name = "user", action = QxcmpConfiguration.QXCMP_BACKEND_URL + "/news/user/article",
...
@EntityTable(value = "草稿箱", name = "userDraft", action = QxcmpConfiguration.QXCMP_BACKEND_URL + "/news/user/article",
        tableActions = @TableAction(value = "新建文章", action = "new", primary = true),
        batchActions = {
...
@EntityTable(value = "审核中文章", name = "userAuditing", action = QxcmpConfiguration.QXCMP_BACKEND_URL + "/news/user/article",
        rowActions = {
                @RowAction(value = "查看", action = "preview", target = AnchorTarget.BLANK),
                @RowAction(value = "撤销申请", action = "repeal", method = FormMethod.POST)
        })
@EntityTable(value = "未通过文章", name = "userRejected", action = QxcmpConfiguration.QXCMP_BACKEND_URL + "/news/user/article",
        batchActions = {
                @BatchAction(value = "批量申请审核", action = "audit", secondary = true)
        },
        rowActions = {
...
@EntityTable(value = "已发布文章", name = "userPublished", action = QxcmpConfiguration.QXCMP_BACKEND_URL + "/news/user/article",
        batchActions = {
...
@EntityTable(value = "已禁用文章", name = "userDisabled", action = QxcmpConfiguration.QXCMP_BACKEND_URL + "/news/user/article",
        batchActions = {
                @BatchAction(value = "批量删除", action = "remove", color = Color.RED)
        },
        rowActions = {
...
@EntityTable(value = "待审核文章", name = "auditing", action = QxcmpConfiguration.QXCMP_BACKEND_URL + "/news/article",
        batchActions = {
...
@EntityTable(value = "已发布文章", name = "published", action = QxcmpConfiguration.QXCMP_BACKEND_URL + "/news/article",
        batchActions = {
                @BatchAction(value = "批量禁用", action = "disable", secondary = true)
        },
        rowActions = {
...
@EntityTable(value = "已禁用文章", name = "disabled", action = QxcmpConfiguration.QXCMP_BACKEND_URL + "/news/article",
        batchActions = {
                @BatchAction(value = "批量删除", action = "remove", color = Color.RED)
        },
        rowActions = {
...
public class Article {
     ...
     */
    @ManyToMany
    @TableField(value = "所属栏目", collectionEntityIndex = "name", maxCollectionCount = 3, enableUrl = true, urlPrefix = QxcmpConfiguration.QXCMP_BACKEND_URL + "/news/user/channel/", urlEntityIndex = "id", urlSuffix = "article")
