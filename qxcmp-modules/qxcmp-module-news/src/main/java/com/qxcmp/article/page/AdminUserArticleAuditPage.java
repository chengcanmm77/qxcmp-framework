...
public class AdminUserArticleAuditPage extends AbstractNewsPage {

    private final ArticleService articleService;
    private final User user;
    private final Article article;
    private final AdminNewsUserArticleAuditForm form;
        ...
        addComponent(viewHelper.nextOverview(article.getTitle(), article.getAuthor())
                .addComponent(new VerticallyDividedGrid().setVerticallyPadded()
                        .addItem(new Row()
                                ...
                                .addCol(new Col().setComputerWide(Wide.TWELVE).setMobileWide(Wide.SIXTEEN).addComponent(getArticleDetailsTable(article)).addComponent(viewHelper.nextForm(form))))
    ...
    protected List<String> getBreadcrumb() {
        return ImmutableList.of("新闻管理", ADMIN_NEWS_URL, "我的文章", ADMIN_NEWS_URL + "/user/article", "申请审核");
    }
}
