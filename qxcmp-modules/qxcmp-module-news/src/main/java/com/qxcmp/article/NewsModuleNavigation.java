...
public class NewsModuleNavigation implements NavigationLoader {
    ...
    public static final String ADMIN_MENU_NEWS = "ADMIN-NEWS";
    public static final String ADMIN_MENU_NEWS_USER_CHANNEL = ADMIN_MENU_NEWS + "-USER-CHANNEL";
    public static final String ADMIN_MENU_NEWS_USER_ARTICLE = ADMIN_MENU_NEWS + "-USER-ARTICLE";
    public static final String ADMIN_MENU_NEWS_ARTICLE_AUDITING = ADMIN_MENU_NEWS + "-ARTICLE-AUDITING";
    public static final String ADMIN_MENU_NEWS_ARTICLE_PUBLISHED = ADMIN_MENU_NEWS + "-ARTICLE-PUBLISHED";
    public static final String ADMIN_MENU_NEWS_ARTICLE_DISABLED = ADMIN_MENU_NEWS + "-ARTICLE-DISABLED";
    public static final String ADMIN_MENU_NEWS_CHANNEL = ADMIN_MENU_NEWS + "-CHANNEL";
    ...
    public void configNavigation(NavigationService navigationService) {
        navigationService.get(NAVIGATION_ADMIN_SIDEBAR)
                .addItem(new Navigation(NAVIGATION_ADMIN_SIDEBAR_NEWS, "新闻管理", ADMIN_NEWS_URL).setIcon(new Icon("newspaper")).setOrder(30).setPrivilegesAnd(ImmutableSet.of(PRIVILEGE_NEWS)));
        navigationService.add(new Navigation(ADMIN_MENU_NEWS, "新闻管理导航栏")
                .addItem(new Navigation(ADMIN_MENU_NEWS_USER_ARTICLE, "我的文章", ADMIN_NEWS_URL + "/user/article").setOrder(10).setPrivilegesAnd(ImmutableSet.of(PRIVILEGE_NEWS)))
                .addItem(new Navigation(ADMIN_MENU_NEWS_ARTICLE_AUDITING, "待审核文章", ADMIN_NEWS_URL + "/article/auditing").setOrder(20).setPrivilegesAnd(ImmutableSet.of(PRIVILEGE_NEWS_ARTICLE_AUDIT)))
                .addItem(new Navigation(ADMIN_MENU_NEWS_ARTICLE_PUBLISHED, "已发布文章", ADMIN_NEWS_URL + "/article/published").setOrder(30).setPrivilegesAnd(ImmutableSet.of(PRIVILEGE_NEWS_ARTICLE_MANAGEMENT)))
                .addItem(new Navigation(ADMIN_MENU_NEWS_ARTICLE_DISABLED, "已禁用文章", ADMIN_NEWS_URL + "/article/disabled").setOrder(40).setPrivilegesAnd(ImmutableSet.of(PRIVILEGE_NEWS_ARTICLE_MANAGEMENT)))
                .addItem(new Navigation(ADMIN_MENU_NEWS_USER_CHANNEL, "我的栏目", ADMIN_NEWS_URL + "/user/channel").setOrder(50).setPrivilegesAnd(ImmutableSet.of(PRIVILEGE_NEWS)))
                .addItem(new Navigation(ADMIN_MENU_NEWS_CHANNEL, "栏目管理", ADMIN_NEWS_URL + "/channel").setOrder(60).setPrivilegesAnd(ImmutableSet.of(PRIVILEGE_NEWS_CHANNEL)))
        );
