...
@Component
public class AdminAdvertisementEditPage extends AbstractQxcmpAdminFormPage<AdminAdvertisementEditForm> {

    public AdminAdvertisementEditPage(AdminAdvertisementEditForm form, BindingResult bindingResult) {
        super(form, bindingResult);
    }

    @Override
    protected List<String> getBreadcrumb() {
        return ImmutableList.of("广告管理", ADMIN_ADVERTISEMENT_URL, "编辑广告");
    }
}
