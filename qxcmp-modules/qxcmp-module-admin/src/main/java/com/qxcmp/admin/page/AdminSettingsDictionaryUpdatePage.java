...
@Component
public class AdminSettingsDictionaryUpdatePage extends AbstractQxcmpAdminFormPage<AdminSettingsDictionaryForm> {
    public AdminSettingsDictionaryUpdatePage(AdminSettingsDictionaryForm form, BindingResult bindingResult) {
