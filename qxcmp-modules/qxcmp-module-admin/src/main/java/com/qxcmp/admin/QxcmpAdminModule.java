...
public class QxcmpAdminModule {
    ...
    public static final String ADMIN_USER_URL = ADMIN_URL + "/user";
    ...
    public static final String ADMIN_SMS_URL = ADMIN_URL + "/sms";
     ...
     * 短信发送动态
     */
    public static final String ADMIN_SMS_FEED = "ADMIN-SMS-FEED";
}
