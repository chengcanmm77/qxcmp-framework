...
@Component
public class AdminSecurityRoleNewPage extends AbstractQxcmpAdminFormPage<AdminSecurityRoleNewForm> {
    public AdminSecurityRoleNewPage(AdminSecurityRoleNewForm form, BindingResult bindingResult) {
    ...
    protected List<String> getBreadcrumb() {
        return ImmutableList.of("安全配置", ADMIN_SECURITY_URL, "角色管理", ADMIN_SECURITY_URL + "/role", "新建角色");
    }
}
