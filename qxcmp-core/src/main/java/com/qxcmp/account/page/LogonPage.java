...
public class LogonPage extends BaseAccountPage {
    ...
    public void renderContent(Col col) {
        col.addComponent(new Segment().addComponent(new PageHeader(HeaderType.H2, siteService.getTitle()).setImage(new Image(siteService.getLogo())).setSubTitle("账户注册").setDividing().setAlignment(Alignment.LEFT))
