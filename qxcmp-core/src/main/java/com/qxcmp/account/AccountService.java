...
public class AccountService implements QxcmpInitializer {
    ...
    public void reset(String id, AccountResetForm form, BindingResult bindingResult) {
        ...
        applicationContext.publishEvent(new UserResetEvent(userService.update(code.getUserId(), user -> {
            user.setPassword(new BCryptPasswordEncoder().encode(form.getPassword()));
     ...
     * @param bindingResult 错误对象
     */
    public void activate(AccountActivateForm form, BindingResult bindingResult) {
        ...
        userOptional.ifPresent(this::sendActivateEmail);
    }
    ...
    public void activate(String id) {
        ...
        applicationContext.publishEvent(new UserLogonEvent(userService.update(code.getUserId(), user -> {
            user.setEnabled(true);
            codeService.delete(code);
        })));
    }
